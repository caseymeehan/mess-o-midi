...
// Get user's projects
$projects = $projectsManager->getUserProjects($user['id']);
...
<body>
    ...
    <main class="main-container">
        ...
        <div class="page-header">
            ...
            <?php if ($usage['can_create']): ?>
                <a href="<?php echo url('/dashboard/project-new.php'); ?>" class="new-btn">
                    <span>+</span> New
                </a>
            <?php else: ?>
        ...
        <div class="usage-widget">
            <div class="usage-header">
                <div class="usage-title">Project Usage</div>
            ...
            <div class="usage-count">
                ...
                <?php if ($usage['limit'] !== null): ?>
                    <span class="limit">/ <?php echo $usage['limit']; ?> projects</span>
                <?php else: ?>
                    <span class="limit">projects (unlimited)</span>
                <?php endif; ?>
            </div>
        ...
        <?php if ($projectCount > 0): ?>
            ...
            <div class="items-list">
                <?php foreach ($projects as $project): ?>
                    <div class="item-row" onclick="editProject(<?php echo $project['id']; ?>)">
                        <div class="item-title"><?php echo escape($project['title']); ?></div>
                        <div class="hamburger-menu">
                            <button class="hamburger-btn" onclick="toggleHamburger(event, <?php echo $project['id']; ?>)">⋮</button>
                            <div class="hamburger-dropdown" id="hamburger-<?php echo $project['id']; ?>">
                                <div class="hamburger-item" onclick="editProject(event, <?php echo $project['id']; ?>)">Edit</div>
                                <div class="hamburger-item" onclick="duplicateProject(event, <?php echo $project['id']; ?>)">Duplicate</div>
                                <div class="hamburger-item danger" onclick="deleteProject(event, <?php echo $project['id']; ?>)">Delete</div>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
        ...
        <?php else: ?>
            ...
            <div class="empty-state">
                ...
                <a href="<?php echo url('/dashboard/project-new.php'); ?>" class="empty-state-btn">
                    <span style="font-size: 1.25rem;">+</span> Create your first project
                </a>
            </div>
        <?php endif; ?>
    </main>
    ...
    <script>
        ...
        // Action Functions
        function editProject(eventOrId, projectId) {
            ...
            if (typeof eventOrId === 'object' && eventOrId.stopPropagation) {
                ...
                window.location.href = '<?php echo url('/dashboard/project-edit.php'); ?>?id=' + projectId;
            } else {
                // Called from row click - eventOrId is actually the projectId
                window.location.href = '<?php echo url('/dashboard/project-edit.php'); ?>?id=' + eventOrId;
            }
        }

        function duplicateProject(event, projectId) {
            event.stopPropagation();
            if (confirm('Duplicate this project?')) {
                window.location.href = '<?php echo url('/dashboard/project-actions.php'); ?>?action=duplicate&id=' + projectId;
            }
        }
        ...
        function deleteProject(event, projectId) {
            ...
            if (confirm('Are you sure you want to delete this project? This action cannot be undone.')) {
                window.location.href = '<?php echo url('/dashboard/project-actions.php'); ?>?action=delete&id=' + projectId;
            }
        }
